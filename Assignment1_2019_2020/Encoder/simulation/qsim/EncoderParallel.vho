...
-- Equation(s):
-- \xor5|y~combout\ = ( \m[2]~input_o\ & ( \m[0]~input_o\ & ( !\m[3]~input_o\ $ (!\m[1]~input_o\) ) ) ) # ( !\m[2]~input_o\ & ( \m[0]~input_o\ & ( !\m[3]~input_o\ $ (\m[1]~input_o\) ) ) ) # ( \m[2]~input_o\ & ( !\m[0]~input_o\ & ( !\m[3]~input_o\ $ 
...
-- Equation(s):
-- \xor7|y~combout\ = ( \m[2]~input_o\ & ( \m[0]~input_o\ & ( \m[1]~input_o\ ) ) ) # ( !\m[2]~input_o\ & ( \m[0]~input_o\ & ( !\m[1]~input_o\ ) ) ) # ( \m[2]~input_o\ & ( !\m[0]~input_o\ & ( !\m[1]~input_o\ ) ) ) # ( !\m[2]~input_o\ & ( !\m[0]~input_o\ & ( 
-- \m[1]~input_o\ ) ) )
...
-- Equation(s):
-- \xor6|y~combout\ = ( \m[0]~input_o\ & ( !\m[3]~input_o\ $ (\m[1]~input_o\) ) ) # ( !\m[0]~input_o\ & ( !\m[3]~input_o\ $ (!\m[1]~input_o\) ) )
...
-- Equation(s):
-- \xor1|y~combout\ = ( !\m[1]~input_o\ & ( \m[0]~input_o\ ) ) # ( \m[1]~input_o\ & ( !\m[0]~input_o\ ) )
...
-- Equation(s):
-- \xor4|y~combout\ = ( \m[2]~input_o\ & ( \m[0]~input_o\ & ( \m[3]~input_o\ ) ) ) # ( !\m[2]~input_o\ & ( \m[0]~input_o\ & ( !\m[3]~input_o\ ) ) ) # ( \m[2]~input_o\ & ( !\m[0]~input_o\ & ( !\m[3]~input_o\ ) ) ) # ( !\m[2]~input_o\ & ( !\m[0]~input_o\ & ( 
-- \m[3]~input_o\ ) ) )
...
-- Equation(s):
-- \xor3|y~combout\ = ( !\m[2]~input_o\ & ( \m[0]~input_o\ ) ) # ( \m[2]~input_o\ & ( !\m[0]~input_o\ ) )
...
-- Equation(s):
-- \xor2|y~combout\ = ( \m[0]~input_o\ & ( !\m[3]~input_o\ ) ) # ( !\m[0]~input_o\ & ( \m[3]~input_o\ ) )
